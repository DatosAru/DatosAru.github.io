...
El operativo de campo se dividio en 3 fases:

_Llamadas telefónicas a los estudiantes seleccionados en la muestra, de los que se tenia su número telefónico o dirección de whatsapp_
_Busqueda en operativo de campo, de los estudiantes que no contestaron la llamada telefónica, empleando la dirección disponible del listado de estudiantes_
_Llamada telefónica a estudiantes que no respondieron en la primera fase ni fueron hallados en el operativo de campo_
